#' @importFrom gDRutils fit_curves logisticFit get_header reset_headers get_identifier set_identifier reset_identifiers convert_se_assay_to_dt validate_SE flatten split_SE_components
