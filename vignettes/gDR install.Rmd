...
It is necessary to update rplatform/dependencies.yaml to use github.com instead of github.roche.com for gDRutils, gDRtestData and gDRstyle. For example, the section for gDRstyle should be updated as follows:
```{}
  gDRstyle:
    ver: '>=0.0.3'
