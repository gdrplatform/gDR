...
Firstly we need to define config with information about storing data. We can prepare our own basing on template from gDRcomponets using functions `prepare_config` and `load_config`
